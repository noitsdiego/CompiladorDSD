...
class Arreglo() :Sentencia(){
    ...
    override fun llenarTablaSimbolos(tablaSimbolos: TablaSimbolos, listaErrores: ArrayList<ErrorSemantico>, ambito: Simbolo) {
        tablaSimbolos.guardarSimboloValor(nombreArreglo!!.lexema,tipoDato!!.lexema,ambito,nombreArreglo!!.fila,nombreArreglo!!.columna)
    }
